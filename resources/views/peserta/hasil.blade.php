...
<body >
  ...
  <p align="center">
    <span class="mr-2 d-none d-lg-inline text-white-600 small" style="color: black; text-transform: uppercase;" >
      <?php $peserta= App\Models\Peserta::where('id',Auth::guard('peserta')->id())->first();?><b>{{$peserta->nama}}</b></span>
        </p>
  </font>
  <p align="center">
  <center><table class="table mt-5" style="background-color: cornflowerblue; width: 80%; font-color: white">
    <tr>
        ...
        <td style="width: 30%; color:white"text-transform: uppercase;>{{$peserta->tempat_lahir}}/ {{$peserta->tanggal_lahir}}</td>
    </tr>
    <tr>
        <td style="width: 30%; color:white" vertical-align: top;">JENIS KELAMIN</td>
        <td style="width: 5%; color:white" vertical-align: top;">:</td>
        <td style="width: 30%; color:white"text-transform: uppercase;>{{$peserta->jenis_kelamin}}</td>
    </tr>
    <tr>
